                        ...
                        <form:form id="register-form" action="${registerURL}" modelAttribute="user"
                            ...
                            <div class="form-group">
                                <input type="password" name="confirm-password" id="confirm-password" tabindex="2"
                                       class="form-control" placeholder="${confirmPasswordLabel}"
                                       onkeyup="checkPass(); return false;"/>
                                <div class="alert-danger">
                                    <span id="checkinpassword.errors" style="display:none"><spring:message
                                            code="login.PasswordDontMatch.label"/></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
